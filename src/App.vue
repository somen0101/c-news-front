  ...
  <v-app>
    <v-app-bar class="header-bar" flat dark dense fixed app clipped-left>
      ...
      <div v-if="checkusername()">
        ようこそ
        <router-link
          :to="{ name: 'bookmark', params: { username: username } }"
    ...
    <v-navigation-drawer v-model="drawer" app clipped floating>
      <v-list shaped dense class="py-5">
        ...
        <v-list-item
          exact
          router-link
          :to="{ name: 'news', params: { domain_tags: 'jp' } }"
        >
          <v-list-item-icon>
      ...
      <v-list-item>
        <v-list-item-content class="subtitle-1">
          このサイトの記事には感情解析が用いられています。
        </v-list-item-content>
      </v-list-item>
      <v-list-item>
        <v-list-item-content class="caption">
          感情解析結果(-1.0から1.0の感情数値)に応じてどんな内容の記事かが一目でわかります。
        </v-list-item-content>
      </v-list-item>
      <v-list-item>
        <v-list-item-icon>
      ...
      <v-list-item>
        ...
        <v-list-item-content class="caption"
          >感情数値 -0.2 ~ 0.4</v-list-item-content
        >
      </v-list-item>
      <v-list-item>
        <v-list-item-icon>
        ...
        <v-list-item-content class="caption"
          >感情数値 -0.3以下</v-list-item-content
        >
      </v-list-item>
      <v-divider />
